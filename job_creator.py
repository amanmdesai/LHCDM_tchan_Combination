...
parser.add_argument("--wmratio", type=str,help='yes/no for fixed wy/my ratio',default="no")
            ...
            for model in MODELArray:
                for quark in QuarkArray:
                    for order in OrderArray:
                            ...
                            os.system("echo python NLOCombination.py --MY {} --MX {} --coup {} --quark {} --order NLO --model {} --input {} --output {} --wmratio {} >> {}".format(my, mx, coup, quark, model, args.input, args.output, args.wmratio, run_name))
