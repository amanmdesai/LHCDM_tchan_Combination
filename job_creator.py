            ...
            for model in MODELArray:
                for quark in QuarkArray:
                    for order in OrderArray:
                            ...
                            os.system("echo Output                = log/ap.{}.\$(ClusterId).\$(ProcId).out >> {}".format(job_name,job_name))
                            os.system("echo Error                 = log/ap.{}.\$(ClusterId).\$(ProcId).err >> {}".format(job_name,job_name))
                            os.system("echo Log                   = log/ap.{}.\$(ClusterId).\$(ProcId).log >> {}".format(job_name,job_name))
